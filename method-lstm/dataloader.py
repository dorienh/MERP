    ...
    def gen_dataset(self):
        ...
        class averagedDataset(Dataset):
            ...
            def __init__(self, feat_dict, ave_exps):
                ...
                # averaging the 10 labels so the lstm output can be for a scalar
                # self.labels = [np.mean(item) for sublist in labels for item in sublist]
...
if __name__ == "__main__":
    ...
    # print(np.shape(list(train_feat_dict.values())[0]))