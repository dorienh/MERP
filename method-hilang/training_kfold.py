...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_name', type=str, default='testing', help='Name of folder plots and model will be saved in')
    ...
    for fold_i in range(num_folds):
        ...
        for songurl in test_feat_dict.keys():
            single_test(model, fold_i, songurl, original_exps, args)
